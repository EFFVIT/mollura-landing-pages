...
export const metadata: Metadata = {
  title: 'Privacy Policy | Mollura Medical Hair Restoration',
  ...
  return (
    <div style={{ fontFamily: "'Jost', 'Open Sans', sans-serif", color: '#1a1a1a', background: WHITE }}>
      ...
      <div style={{ background: DARK, padding: '48px 48px', textAlign: 'center' }}>
        <h1 style={{ fontFamily: "'Judson', Georgia, serif", fontWeight: 400, color: WHITE, fontSize: 40, margin: 0, lineHeight: 1.129 }}>Privacy Policy</h1>
      ...
      <main style={{ maxWidth: 860, margin: '0 auto', padding: '64px 48px' }}>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 24 }}>
          Thank you for choosing to be part of our community at Mollura Medical Hair Restoration (&quot;company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at <a href="mailto:Hairsurg@mollurahairtransplant.com" style={{ color: DARK }}>Hairsurg@mollurahairtransplant.com</a>.
        </p>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 24 }}>
          When you visit our website https://start.mollurahairtransplant.com and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we describe our privacy policy. We seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our websites and our services.
        </p>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 48 }}>
          This privacy policy applies to all information collected through our website (such as https://start.mollurahairtransplant.com) and/or any related services, sales, marketing or events.
        </p>

        <hr style={{ border: 'none', borderTop: '1px solid #e8e8e8', marginBottom: 48 }} />

        <h2 style={{ fontSize: 18, fontWeight: 700, color: DARK_NAV, marginBottom: 16 }}>Table of Contents</h2>
        ...
        <Section title="11. How Can You Contact Us About This Policy?">
          <p>If you have questions or comments about this policy, you may email us at <a href="mailto:Hairsurg@mollurahairtransplant.com" style={{ color: DARK }}>Hairsurg@mollurahairtransplant.com</a> or by post to:</p>
        ...
        <div style={{ background: '#f4f8fb', borderLeft: `4px solid ${DARK}`, padding: '24px 28px', borderRadius: 4 }}>
          ...
          <p style={{ fontSize: 15, color: '#444', lineHeight: 1.7, margin: 0 }}>
            According to the Privacy Policy, you agree to share your personal data with our service. However, you still have the right to update, transfer or delete it from us at any time. If you need further management for your data, please contact us at <a href="mailto:Hairsurg@mollurahairtransplant.com" style={{ color: DARK }}>Hairsurg@mollurahairtransplant.com</a>.
          </p>
        </div>
      </main>
